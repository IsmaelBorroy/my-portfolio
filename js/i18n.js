...
export const translations = {
  en: {
    ...
    exp_1_desc:     'Building AI-powered MVPs and proofs of concept for enterprise clients across Latin America. Projects span document processing, AI agents, and data analytics using IBM watsonx technologies, Python, React, and cloud-native tools. Also delivered virtual and in-person bootcamps for clients on watsonx Orchestrate and IBM Bob.',
  ...
  es: {
    ...
    exp_1_role:     'AI Engineer · IBM',
    exp_1_period:   '2025 – 2026',
    exp_1_desc:     'Construcción de MVPs y pruebas de concepto con IA para clientes empresariales en América Latina. Los proyectos abarcan procesamiento de documentos, agentes de IA y analítica de datos usando tecnologías IBM watsonx, Python, React y herramientas cloud-native. También impartí bootcamps virtuales y presenciales para clientes sobre watsonx Orchestrate e IBM Bob.',
